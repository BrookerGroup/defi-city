...
export default function AppPage() {
  ...
  useEffect(() => {
    console.log(`[App] Current buildings in state: ${buildings.length}`, buildings)
  }, [buildings])
  ...
  if (!ready) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-900">
        <p className="text-amber-400 text-sm animate-pulse" style={{ fontFamily: '"Press Start 2P", monospace' }}>LOADING...</p>
      </div>
    )
  }
  ...
  if (!authenticated) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center gap-8 bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900">
        <h1 className="text-amber-400 text-3xl" style={{ fontFamily: '"Press Start 2P", monospace', textShadow: '4px 4px 0px #92400E' }}>DEFICITY</h1>
        <button onClick={login} className="relative group">
          <div className="absolute inset-0 bg-amber-900 translate-x-2 translate-y-2" />
          <div className="relative px-8 py-4 bg-amber-600 border-4 border-amber-400 text-white font-bold transition-transform group-hover:-translate-y-1" style={{ fontFamily: '"Press Start 2P", monospace' }}>CONNECT WALLET</div>
        </button>
      </div>
    )
  }
  ...
  if (!address) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center gap-4 bg-slate-900">
        <p className="text-amber-400 text-sm animate-pulse" style={{ fontFamily: '"Press Start 2P", monospace' }}>CONNECTING WALLET...</p>
        {waitingTooLong && (
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900">
          ...
          <div className="relative max-w-lg mx-4">
            ...
            <div className="relative bg-gradient-to-b from-slate-800 to-slate-900 border-4 border-amber-500 p-8">
              ...
              <div className="absolute -top-6 left-1/2 -translate-x-1/2 px-6 py-2 bg-amber-600 border-4 border-amber-400">
                <p className="text-white text-[10px]" style={{ fontFamily: '"Press Start 2P", monospace' }}>
                  ⚠️ REQUIRED ⚠️
                </p>
              </div>
              ...
              <div className="flex justify-center mb-6 mt-4">
                <div className="relative">
                  <div className="text-8xl animate-bounce" style={{ animationDuration: '2s' }}>🏛️</div>
                  {/* Glow effect */}
              ...
              >
                BUILD YOUR<br/>TOWN HALL
              </h2>
              
              {/* Description */}
              <p className="text-center text-slate-400 text-xs leading-relaxed mb-6" style={{ fontFamily: '"Press Start 2P", monospace' }}>
              ...
              <div className="bg-slate-900/80 border-2 border-slate-700 p-4 mb-6">
                <p className="text-slate-500 text-[8px] mb-3" style={{ fontFamily: '"Press Start 2P", monospace' }}>UNLOCKS:</p>
                <div className="space-y-2">
                  {['🏦 AAVE Bank Building', '💰 Deposit & Withdraw', '🎮 City Management', '📈 DeFi Strategies'].map((item, i) => (
                    <div key={i} className="flex items-center gap-2 text-[10px] text-green-400" style={{ fontFamily: '"Press Start 2P", monospace' }}>
              ...
              {/* Cost Info */}
              <p className="text-center text-slate-600 text-[8px] mt-4" style={{ fontFamily: '"Press Start 2P", monospace' }}>
          ...
          <div className="relative max-w-2xl w-full mx-4">
            ...
            <div className="relative bg-gradient-to-b from-slate-800 to-slate-900 border-4 border-emerald-500 p-6">
              ...
              <div className="text-center mb-6">
                <p className="text-emerald-400 text-[10px] mb-2" style={{ fontFamily: '"Press Start 2P", monospace' }}>
                  {selectedBuilding
                ...
                <p className="text-slate-400 text-[8px] mt-2" style={{ fontFamily: '"Press Start 2P", monospace' }}>
                  {selectedBuilding
        ...
        <div className="container mx-auto px-4 py-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
            ...
            <div className="bg-slate-800/60 border border-slate-700 px-3 py-2">
              <p className="text-slate-500 text-[6px] mb-1" style={{ fontFamily: '"Press Start 2P", monospace' }}>WALLET</p>
              <p className="text-cyan-400 text-[8px] truncate">{address}</p>
            </div>
            
            {/* Wallet Balances */}
            <div className="bg-slate-800/60 border border-slate-700 px-3 py-2">
              <p className="text-slate-500 text-[6px] mb-1" style={{ fontFamily: '"Press Start 2P", monospace' }}>WALLET BAL</p>
              <div className="flex gap-4 text-[8px]" style={{ fontFamily: '"Press Start 2P", monospace' }}>
            ...
            <div className="bg-slate-800/60 border border-amber-700/50 px-3 py-2">
              <p className="text-slate-500 text-[6px] mb-1" style={{ fontFamily: '"Press Start 2P", monospace' }}>VAULT</p>
              {hasSmartWallet && smartWallet ? (
                <p className="text-amber-400 text-[8px] truncate">{smartWallet}</p>
              ) : (
                <button 
                  onClick={handleCreateTownHall} 
                  disabled={isCreating}
            ...
            {/* Vault Balances */}
            <div className="bg-slate-800/60 border border-amber-700/50 px-3 py-2">
              <p className="text-slate-500 text-[6px] mb-1" style={{ fontFamily: '"Press Start 2P", monospace' }}>VAULT BAL</p>
              <div className="flex gap-4 text-[8px]" style={{ fontFamily: '"Press Start 2P", monospace' }}>
                <span className="text-amber-400">ETH: {parseFloat(smartWalletEthBalance).toFixed(4)}</span>
                <span className="text-amber-400">USDC: {parseFloat(smartWalletUsdcBalance).toFixed(2)}</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <main className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div className="max-w-xl mx-auto">
          ...
          {hasSmartWallet && (
            <div className="relative">
              <div className={`absolute inset-0 ${activeVaultTab === 'deposit' ? 'bg-blue-900' : 'bg-purple-900'} translate-x-2 translate-y-2`} />
